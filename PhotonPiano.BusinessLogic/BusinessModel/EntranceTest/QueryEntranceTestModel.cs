...
public record QueryEntranceTestModel  : QueryPagedModel
{
    ...
    public void Deconstruct(out int page, out int pageSize, out string sortColumn, out bool orderByDesc, out List<Guid>? roomIds, out string? keyword, out List<Shift>? shifts, out List<Guid>? entranceTestIds, out bool isAnnouncedScore, out List<string>? instructorIds)
    {
        page = Page;
        pageSize = PageSize;
    ...
    public void Deconstruct(out List<Guid>? roomIds, out string? keyword, out List<Shift>? shifts, out List<Guid>? entranceTestIds, out bool isAnnouncedScore, out List<string>? instructorIds)
    {
        roomIds = RoomIds;
        keyword = Keyword;
        shifts = Shifts;
