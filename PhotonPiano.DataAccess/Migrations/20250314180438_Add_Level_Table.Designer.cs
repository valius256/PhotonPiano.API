...
namespace PhotonPiano.DataAccess.Migrations
{
    ...
    [Migration("20250314180438_Add_Level_Table")]
    partial class Add_Level_Table
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PhotonPiano.DataAccess.Models.Entity.Level", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8fb54d6e-315c-470d-825e-91b8314134f7"),
                            CreatedAt = new DateTime(2025, 3, 15, 1, 4, 37, 134, DateTimeKind.Utc).AddTicks(9354),
                            ...
                            NextLevelId = new Guid("ad04326c-4d91-4d67-bc76-2c1dfb87c2c5"),
                            PricePerSlot = 200000m,
                            RecordStatus = 1,
                            SkillsEarned = new List<string> { "Hiểu biết cơ bản về bàn phím piano và vị trí các nốt nhạc.", "Đọc nốt nhạc trên khóa Sol và khóa Fa.", "Rèn luyện ngón tay với các bài tập đơn giản.", "Chơi các giai điệu cơ bản bằng cả hai tay.", "Nhận biết nhịp điệu đơn giản (2/4, 3/4, 4/4).", "Áp dụng kỹ thuật legato (chơi liền tiếng) và staccato (chơi ngắt tiếng) cơ bản." },
                            SlotPerWeek = 2,
                            TotalSlots = 30
                        },
                        new
                        {
                            Id = new Guid("ad04326c-4d91-4d67-bc76-2c1dfb87c2c5"),
                            CreatedAt = new DateTime(2025, 3, 15, 1, 4, 37, 135, DateTimeKind.Utc).AddTicks(1780),
                            ...
                            NextLevelId = new Guid("3db94220-15db-4880-9b57-b6064b27c11b"),
                            PricePerSlot = 250000m,
                            RecordStatus = 1,
                            SkillsEarned = new List<string> { "Chơi những bản nhạc có hai tay độc lập với các tiết tấu khác nhau.", "Hiểu và áp dụng dấu hóa (♯, ♭) vào bài nhạc.", "Chuyển đổi hợp âm cơ bản và đệm đàn đơn giản.", "Sử dụng pedal sustain một cách cơ bản.", "Phát triển khả năng cảm âm và điều chỉnh lực đánh phím." },
                            SlotPerWeek = 2,
                            TotalSlots = 30
                        },
                        new
                        {
                            Id = new Guid("3db94220-15db-4880-9b57-b6064b27c11b"),
                            CreatedAt = new DateTime(2025, 3, 15, 1, 4, 37, 135, DateTimeKind.Utc).AddTicks(1801),
                            ...
                            NextLevelId = new Guid("0d232654-2ce8-4193-9bc3-acd3eddf2ff2"),
                            PricePerSlot = 300000m,
                            RecordStatus = 1,
                            SkillsEarned = new List<string> { "Chơi các bản nhạc có tiết tấu nhanh hơn và nhiều kỹ thuật hơn.", "Sử dụng pedal một cách linh hoạt để tạo hiệu ứng âm thanh tốt hơn.", "Thành thạo các quãng (intervals) và hợp âm 7.", "Chơi các gam (scale) và arpeggio ở nhiều tốc độ khác nhau.", "Đọc bản nhạc nhanh hơn và luyện tập khả năng thị tấu (sight-reading).", "Phát triển phong cách biểu diễn cá nhân." },
                            SlotPerWeek = 2,
                            TotalSlots = 40
                        },
                        new
                        {
                            Id = new Guid("0d232654-2ce8-4193-9bc3-acd3eddf2ff2"),
                            CreatedAt = new DateTime(2025, 3, 15, 1, 4, 37, 135, DateTimeKind.Utc).AddTicks(1808),
                            ...
                            NextLevelId = new Guid("55974743-7c93-47ab-877e-eda4cb9f96c5"),
                            PricePerSlot = 400000m,
                            RecordStatus = 1,
                            SkillsEarned = new List<string> { "Chơi các tác phẩm cổ điển của các nhà soạn nhạc như Mozart, Beethoven, Chopin...", "Kỹ thuật legato, staccato, trill, tremolo ở mức độ cao.", "Kiểm soát lực đánh phím để tạo độ sâu và sắc thái âm nhạc phong phú.", "Thị tấu ở tốc độ cao hơn và có độ chính xác cao.", "Sử dụng pedal một cách chuyên nghiệp để nâng cao hiệu ứng âm thanh.", "Khả năng chơi piano với nhiều thể loại khác nhau (cổ điển, jazz, pop, đệm hát...)." },
                            SlotPerWeek = 2,
                            TotalSlots = 40
                        },
                        new
                        {
                            Id = new Guid("55974743-7c93-47ab-877e-eda4cb9f96c5"),
                            CreatedAt = new DateTime(2025, 3, 15, 1, 4, 37, 135, DateTimeKind.Utc).AddTicks(1814),
