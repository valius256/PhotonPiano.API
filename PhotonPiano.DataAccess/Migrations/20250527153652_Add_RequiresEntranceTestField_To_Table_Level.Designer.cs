...
namespace PhotonPiano.DataAccess.Migrations
{
    ...
    [Migration("20250527153652_Add_RequiresEntranceTestField_To_Table_Level")]
    partial class Add_RequiresEntranceTestField_To_Table_Level
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PhotonPiano.DataAccess.Models.Entity.Account", b =>
                {
                    ...
                    b.Property<Guid?>("SelfEvaluatedLevelId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SelfEvaluatedLevelId");
            ...
            modelBuilder.Entity("PhotonPiano.DataAccess.Models.Entity.FreeSlot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PhotonPiano.DataAccess.Models.Entity.Level", b =>
                {
                    ...
                    b.Property<bool>("RequiresEntranceTest")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("PhotonPiano.DataAccess.Models.Entity.SlotStudent", b =>
                {
                    ...
                    b.Property<string>("GestureComment")
                        .HasColumnType("text");

                    b.Property<string>("GestureUrl")
                        .HasColumnType("text");

                    b.Property<string>("PedalComment")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("PhotonPiano.DataAccess.Models.Entity.StudentClass", b =>
                {
                    ...
                    b.Property<bool>("HasCertificateHtml")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("PhotonPiano.DataAccess.Models.Entity.Account", b =>
                {
                    ...
                    b.HasOne("PhotonPiano.DataAccess.Models.Entity.Level", "SelfEvaluatedLevel")
                        .WithMany("SelfEvaluatedAccounts")
                        .HasForeignKey("SelfEvaluatedLevelId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("SelfEvaluatedLevel");
                });
            ...
            modelBuilder.Entity("PhotonPiano.DataAccess.Models.Entity.Level", b =>
                {
                    ...
                    b.Navigation("SelfEvaluatedAccounts");
                });
